...
WebUI.setText(findTestObject('Object Repository/Page_Login/input_Login Akun_username'), 'admintest')
...
if (halaman_tujuan == 'https://testingjarkom.000webhostapp.com/admin/dashboard.php') {
